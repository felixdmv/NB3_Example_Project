package commodityMarket.myAgent;
...
public class MyNegotiator extends Thread{
	...
	public static void main(String[] args) {
		...
		if(args.length == 0){
			...
			try {
				...
				MyNegotiator negotiator = new MyNegotiator(name, serverAddress, SERVER_PORT);
	...
	//CONSTRUCTOR
	public MyNegotiator(String name, InetAddress serverAddress, int serverPort){
		this.myName = name;
		this.negoClient = new NegotiationClient(serverAddress, serverPort);
		this.nb3Algorithm = new CmNB3Algorithm(this);
		this.nb3Algorithm.setConcessionDegrees(10, 10); // 2 and 4 are the default values.
